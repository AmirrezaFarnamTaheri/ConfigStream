...
GOOS=js GOARCH=wasm go build -ldflags="-checklinkname=0" -tags "with_quic with_dhcp with_wireguard with_ech with_utls with_reality_server with_clash_api with_gvisor" -o ../../../frontend/assets/wasm/tester.wasm wasm_main.go
