...
Single source of truth for DNS intelligence data used by dns_profiles.py and tools.
"""
...
IRAN_INFRASTRUCTURE_DNS: Dict[str, str] = {
...
# Special Cloudflare IPs reported to work better in censored regions.
# Note: .0 addresses here are anycast endpoints, not subnet addresses.
CLOUDFLARE_OPTIMIZED_IPS: List[str] = [
    "34.153.65.94",
    "34.153.64.86",
    "34.153.65.92",
    "208.103.161.11",
...
ZEUS_DNS: List[str] = ["37.32.5.60", "37.32.5.61"]
