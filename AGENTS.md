...
*   **Time Limits**: `BATCH_TIME_LIMIT_SECONDS = 14400` (4h00m fetch/parse/test) + `BATCH_TIME_LIMIT_GRACE_SECONDS = 900` (15m for consumers to drain in-flight work, then output generation runs after gather).
