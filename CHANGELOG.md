...
- **P2-8 validation run**: `npm run build` passes; `npm run test:frontend:no-network` passes; frontend local-first, workflow, and documentation hygiene pytest checks pass. Python Playwright e2e remains subject to the existing browser-bundle skip tracked under P2-9.
