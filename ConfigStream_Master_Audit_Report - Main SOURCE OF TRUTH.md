...
- **Bandit gate stabilized**: `py -3.13 -m bandit -r src/configstream scripts tools frontend/assets/js -q` now passes cleanly after tightening subprocess invocation patterns and adding explicit safe suppressions for intentional local-tooling subprocess usage.
