...
class TestFetcherSync(unittest.TestCase):

    def test_adaptive_timeout_logic_sync(self):
        async def _test():
            ...
            # NOTE: If p95 is used, it needs enough data.
            # In our test we provide 100 samples of 50ms.
            # p95 of 50ms is 50ms. Target = 100ms.
            # Initial 10.0. Drifting to 0.1.
            assert current < 9.0
    ...
    def test_fetch_multiple_batch_sync(self):
        async def _test():
