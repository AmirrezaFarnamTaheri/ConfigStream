...
def test_filter_unique_endpoints():
    p1 = create_test_proxy(source="s1", address="1.1.1.1", port=443, protocol="vmess", is_working=True)
    p2 = create_test_proxy(source="s2", address="1.1.1.1", port=443, protocol="vmess", is_working=True) # Duplicate
    p3 = create_test_proxy(source="s3", address="2.2.2.2", port=443, protocol="vmess", is_working=True)
...
def test_filter_different_protocols_same_port():
    p1 = create_test_proxy(source="s1", address="1.1.1.1", port=443, protocol="vmess", is_working=True)
    p2 = create_test_proxy(source="s2", address="1.1.1.1", port=443, protocol="vless", is_working=True) # Diff proto
...
def test_filter_with_auth_diff():
    p1 = create_test_proxy(source="s1", address="1.1.1.1", port=443, protocol="vmess", uuid="u1", is_working=True)
    p2 = create_test_proxy(source="s2", address="1.1.1.1", port=443, protocol="vmess", uuid="u2", is_working=True)
