...
from configstream.plugins.loader import WasmParser, PluginManager
...
class TestWasmPlugin(unittest.TestCase):
    ...
    @patch("configstream.plugins.loader.Module")
    @patch("configstream.plugins.loader.Instance")
    def test_wasm_parser_execution(self, MockInstance, MockModule, MockStore, MockEngine):
        ...
        mock_dealloc.assert_called_with(parser.store, 100, len(config_str.encode('utf-8')))
