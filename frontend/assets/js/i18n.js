const translations = {
    en: {
        ...
        "downloads.dns_profile.standard": "Standard (default)",
        "downloads.dns_profile.safe": "DNS-safe (IP-only)",
        "downloads.dns_profile.hardened": "DNS-hardened (DoH/DoT/DoQ + prefer IP)",
        "downloads.dns_profile.desc": "Pick the DNS profile for downloads. DNS-safe uses IP-only endpoints; DNS-hardened keeps hostnames but prefers IP when available and embeds encrypted resolvers.",
