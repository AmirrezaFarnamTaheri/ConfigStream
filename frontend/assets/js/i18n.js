const translations = {
    en: {
        ...
        "downloads.sideproducts.desc": "OpenVPN, WireGuard, and plain URIs for direct client import.",
    ...
    zh: {
        ...
        "downloads.sideproducts.desc": "包含 OpenVPN、WireGuard 和纯 URI 格式，可直接导入客户端。",
        "downloads.raw": "原始配置",
    ...
    fa: {
        ...
        "downloads.sideproducts.desc": "شامل OpenVPN، WireGuard و URI ساده برای وارد کردن مستقیم به کلاینت‌ها.",
    ...
    ru: {
        ...
        "downloads.sideproducts.desc": "OpenVPN, WireGuard и plain URI для прямого импорта в клиенты.",
    ...
    ar: {
        ...
        "downloads.sideproducts.desc": "OpenVPN، WireGuard وروابط URI للاستيراد المباشر إلى العميل.",
