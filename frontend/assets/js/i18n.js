const translations = {
    en: {
        ...
        "about.pillar2.text": "Our hybrid Python/Go engine (\"Resilient Core\") automatically scrapes, deduplicates, tests, and \"washes\" thousands of proxies every 3 hours.",
        ...
        "about.arch.agg": "<strong>Global Aggregator:</strong> Scrapes, parses, and normalizes data from over 600 public sources every 3 hours.",
    ...
    zh: {
        ...
        "about.arch.agg": "<strong>聚合器：</strong> 每 3 小时从 668+ 个来源获取数据。",
    ...
    ru: {
        ...
        "about.arch.agg": "<strong>Агрегатор:</strong> Собирает данные из более чем 668 источников каждые 3 часа.",
