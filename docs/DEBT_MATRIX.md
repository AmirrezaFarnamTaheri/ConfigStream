...
- L365 [`LARGE_FUNCTION`] **P1 - High**: `Function to_singbox_outbound spans 556 lines (threshold: 300).`
...
- L405 [`BROAD_EXCEPTION`] **P1 - High**: `Broad exception boundary requires semantic review and structured outcome.`
