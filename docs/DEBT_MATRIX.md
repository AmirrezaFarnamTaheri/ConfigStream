...
- L227 [`LARGE_FUNCTION`] **P1 - High**: `Function source_producer spans 500 lines (threshold: 300).`
...
- L963 [`BROAD_EXCEPTION`] **P1 - High**: `Broad exception boundary requires semantic review and structured outcome.`
