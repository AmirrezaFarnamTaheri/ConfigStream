...
| `CS_PUBLIC_KEY` | no | `direct-only` |  | no | no | `scripts/snapshot_pages_release.py:416`<br>`scripts/validate_pages_artifact.py:201`<br>`scripts/verify_pages_deployment.py:438` |
| `CS_SIGNING_PRIVATE_KEY_HEX` | no | `direct-only` | `<redacted>` | no | yes | `scripts/release_gate.py:338`<br>`src/configstream/output/metadata.py:467` |
...
| `GITHUB_RUN_ATTEMPT` | no | `direct-only` |  | no | no | `scripts/finalize_release_outputs.py:573`<br>`scripts/finalize_release_outputs.py:616`<br>`scripts/generate_evidence_bundle.py:20`<br>`scripts/native_client_checks.py:222`<br>`scripts/release_gate.py:180`<br>`scripts/release_gate.py:392`<br>`scripts/resilient_stage.py:469`<br>`scripts/validate_pages_artifact.py:1187`<br>`scripts/validate_pages_artifact.py:1220`<br>`src/configstream/output/metadata.py:508`<br>`src/configstream/output/metadata.py:541` |
| `GITHUB_RUN_ID` | no | `direct-only` |  | no | no | `scripts/finalize_release_outputs.py:572`<br>`scripts/finalize_release_outputs.py:615`<br>`scripts/generate_evidence_bundle.py:19`<br>`scripts/native_client_checks.py:221`<br>`scripts/release_gate.py:179`<br>`scripts/release_gate.py:389`<br>`scripts/resilient_stage.py:468`<br>`scripts/validate_pages_artifact.py:1186`<br>`scripts/validate_pages_artifact.py:1219`<br>`src/configstream/output/metadata.py:507`<br>`src/configstream/output/metadata.py:540` |
| `GITHUB_SHA` | no | `direct-only` |  | no | no | `scripts/finalize_release_outputs.py:571`<br>`scripts/finalize_release_outputs.py:614`<br>`scripts/generate_evidence_bundle.py:21`<br>`scripts/native_client_checks.py:220`<br>`scripts/release_gate.py:178`<br>`scripts/release_gate.py:386`<br>`scripts/resilient_stage.py:470`<br>`scripts/validate_pages_artifact.py:1185`<br>`scripts/validate_pages_artifact.py:1218`<br>`src/configstream/output/metadata.py:506`<br>`src/configstream/output/metadata.py:539` |
...
| `MAX_SELECTOR_MEMBERS` | no | `direct-only` |  | no | no | `scripts/finalize_release_outputs.py:51` |
| `MAX_WORKERS` | yes | `int` | `128` | no | no | `src/configstream/config.py:70` |
| `MIN_LATENCY` | yes | `int` | `10` | no | no | `src/configstream/config.py:39` |
| `MIN_SOURCE_COVERAGE` | no | `direct-only` |  | no | no | `scripts/finalize_release_outputs.py:631` |
