...
| `CS_SIGNING_PRIVATE_KEY_HEX` | no | `direct-only` | `<redacted>` | no | yes | `scripts/release_gate.py:336`<br>`src/configstream/output/metadata.py:495` |
