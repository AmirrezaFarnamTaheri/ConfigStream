...
| `CS_PUBLIC_KEY` | no | `direct-only` |  | no | no | `scripts/snapshot_pages_release.py:416`<br>`scripts/validate_pages_artifact.py:201`<br>`scripts/verify_pages_deployment.py:440` |
