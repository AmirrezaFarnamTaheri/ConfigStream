...
*   **Files:** `tools/worker.js` (Worker code) and `tools/wrangler.toml` (deployment config). Client profiles require manual configuration with a compatible raw-TCP upstream.
